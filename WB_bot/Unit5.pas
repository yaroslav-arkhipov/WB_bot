...
begin
 ...
 if pos('"errors":null', respStr)<>0 then
   Memo1.Lines.Add('['+Timetostr(time)+']'+'Изменения успешно внесены')
 else
  Memo1.Lines.Add('['+Timetostr(time)+']'+'Неверный запрос');
  end;
end;
end;
